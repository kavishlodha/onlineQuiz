...
var client = new MongoClient('mongodb+srv://kavishlodha:123@cluster0-rtwiy.mongodb.net/onlinequiz?retryWrites=true&w=majority', {useNewUrlParser:true})
...
app.post('/sign-up', bodyParser.json() ,(req,res)=>{  
        ...
        const collection = connection.db('onlinequiz').collection('users');
